  ...
  return (
    ...
    <div className='signup'>
      <form onSubmit={handleSubmit}>
        <br></br>
        <img src="https://codeforgood.net/wp-content/uploads/2023/09/Wellfare-Logo-1536x304.png" height="50px" alt="logo"/>
        ...
        <FormControl>
          ...
          <FormControl>
            ...
            >
              ...
              <Button href="/profile" type="submit" variant="contained" color="primary"> Submit </Button>
              </ThemeProvider>
              <br></br>
              <br></br>
              <br></br>
