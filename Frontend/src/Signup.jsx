...
export default function Signup() {
  ...
  const handleSubmit = (event) => {
    ...
    console.log(`Have you faced food insecurity? ${inputs.insecurity}`)
      ...
      try {
        // Send the form data to the Express API endpoint
        const response = axios.post('http://localhost:4001/submit', {

          orderItems: [], // Fill in the order items based on your form
          user: 'user_id_here', // Replace with the actual user ID
          shipping: {}, // Fill in the shipping data based on your form
          payment: {}, // Fill in the payment data based on your form
          itemsPrice: 0, // Fill in the item price based on your form
          taxPrice: 0, // Fill in the tax price based on your form
          shippingPrice: 0, // Fill in the shipping price based on your form
          totalPrice: 0, // Fill in the total price based on your form
        });
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      <br></br>
      <img
  src="https://codeforgood.net/wp-content/uploads/2023/09/Wellfare-Logo-1536x304.png"
  height="50px"
  alt="CodeForGood Wellfare Logo"
/>
